...
//prop(): form요소(select,checkbox,radio)의 상태 속성값을 가져올때
//prop("checked",true):form요소이 상태 속성값을 업데이트 할때
...
$("input").prop("selectIndex") //-> selected된 요소의 인덱스 값 반환
$("input").prop("tagName") // -> 태그이름
$("input").prop("nodeType")//  ->노드타입
